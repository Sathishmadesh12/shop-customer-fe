...
export const CartProvider = ({ children }) => {
  ...
  return (
    <CartContext.Provider value={{ cart, loading, itemCount, cartCount: itemCount, fetchCart, addItem, updateItem, removeItem, applyCoupon, removeCoupon, toggleWallet, clearCart }}>
      {children}
